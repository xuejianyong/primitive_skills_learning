...
from ppl.data_management.env_replay_buffer import EnvReplayBuffer
from ppl.samplers.data_collector import MdpPathCollector
from ppl.torch.sac.policies import (
    TanhGaussianPolicy,
    PAMDPPolicy,
    MakeDeterministic
)
from ppl.torch.sac.sac import SACTrainer
from ppl.torch.sac.sac_hybrid import SACHybridTrainer
from ppl.torch.networks import ConcatMlp
from ppl.torch.torch_rl_algorithm import TorchBatchRLAlgorithm
...
def get_ckpt_update_func(variant):
    ...
    import torch
    from ppl.launchers.conf import LOCAL_LOG_DIR
...
def get_video_save_func(variant):
    from ppl.samplers.rollout_functions import rollout
    from ppl.launchers.visualization import dump_video
