...
from ppl.core import logger
from ppl.launchers import conf
from ppl.torch.pytorch_util import set_gpu_mode
import ppl.pythonplusplus as ppp
...
def run_experiment(
    ...
    :param use_gpu:
    :param snapshot_mode: See ppl.core.logging
    :param snapshot_gap: See ppl.core.logging
    ...
    if mode == 'local':
        ...
        dmode = doodad.mode.EC2AutoconfigDocker(
            ...
            # will start just making the sub-directories within ppl rather
