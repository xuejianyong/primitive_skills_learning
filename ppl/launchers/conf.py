...
maple_project_dir = join(os.path.dirname(ppl.__file__), os.pardir)
...
RUN_DOODAD_EXPERIMENT_SCRIPT_PATH = (
    ...
    # '/home/user/path/to/ppl/scripts/run_experiment_from_doodad.py'
)
"""
AWS Settings
"""
...
SSS_RUN_DOODAD_EXPERIMENT_SCRIPT_PATH = (
    '/global/home/users/USERNAME/path/to/ppl/scripts'
...
try:
    from ppl.launchers.conf_private import *
except ImportError:
